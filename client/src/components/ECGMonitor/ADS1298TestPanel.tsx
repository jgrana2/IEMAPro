...
interface ADS1298TestPanelProps {
  ...
  deviceConnectionStatus: "connected" | "disconnected" | "connecting" | "scanning";
}
    ...
    <Card className="w-full">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Badge className={`${getConnectionColor(deviceConnectionStatus)} text-white`}>
