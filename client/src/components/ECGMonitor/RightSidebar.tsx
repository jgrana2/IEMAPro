...
import { ChevronLeft, Play, Pause, Save, FileText, History } from "lucide-react";
    ...
    >
      <div className="h-full flex flex-col">
        ...
        <div className="p-4 border-b border-border flex items-center justify-between">
          ...
          {isExpanded && (
            <h2 className="font-semibold text-foreground">Recording Sessions</h2>
          )}
        </div>
          ...
          {isExpanded ? (
            <div className="p-4 space-y-6">
              ...
              <div className="space-y-3">
                <h3 className="text-sm font-medium text-foreground">Current Recording</h3>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-3">
                  {(currentPatient ? patientSessions : allSessions).map((session: any) => (
                    <Card 
                      key={session.id} 
